...
public class LoginController {
	...
	@ApiOperation(value = "This api is used to Create Token", notes = "This api is used to Create Authorize Token ")
	...
	public ResponseEntity<CommonResponse> getLogin(@Valid @RequestBody LoginRequest data) throws Exception {
